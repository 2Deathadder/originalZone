...
import { Trash2, Pencil, PackagePlus, UploadCloud, X } from 'lucide-react';
        ...
        {products.map(p => (
          <div key={p.id} className=\"surface p-4 flex items-center justify-between\">
            ...
            <div className=\"flex gap-2\">
              ...
              <button onClick={() => setProducts(products.filter(x=>x.id!==p.id))} className=\"p-2 text-red-400 hover:text-red-600\"><Trash2 size={16}/></button>
            </div>
          </div>
        ))}
      </div>
